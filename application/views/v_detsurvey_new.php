...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Detail Survey New</h1>
        </div><!-- /.col -->
        <div class="col-sm-12">
          <hr>
        </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <label>Respon</label>
                    <select class="form-control" name="id_respon">
                ...
                <div class="row">
                  <?php foreach($quest as  $a) {?>
                    <div class="col-md-3">
                      ...
                      ?>
                      <input type="text" value="<?php echo $a->id_quest ?>" name="<?php echo $paramNameID ?>" readonly>
                      <!-- <input type="text" value="<?php echo $paramNameID ?>" name=""> -->
                      <?php if(isset($det->id_detsurv)) {?>
                      <input type="text" value="<?php echo $a->id_quest ?>">
                      <?php } ?>
                      <select class="form-control" name="<?php echo $paramNameNilai ?>">
                        <?php for ($i=1; $i < 11 ; $i++) { ?>
